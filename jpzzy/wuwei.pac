var FindProxyForURL = function(init, profiles) {
    ...
    "+auto switch": function(url, host, scheme) {
        ...
        if (/(?:^|\.)marist\.edu$/.test(host)) return "+proxy";
        if (/(?:^|\.)scikit-learn\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)prismic\.io$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)suying988\.net$/.test(host)) return "DIRECT";
        if (/(?:^|\.)idappstore\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)pku\.edu\.cn$/.test(host)) return "DIRECT";
        if (/(?:^|\.)buttons\.github\.io$/.test(host)) return "DIRECT";
        if (/(?:^|\.)d2l\.ai$/.test(host)) return "DIRECT";
        ...
        if (/(?:^|\.)content-earthengine\.googleapis\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)hoyoverse\.com$/.test(host)) return "DIRECT";
        if (/(?:^|\.)googleusercontent\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)localhost$/.test(host)) return "+proxy";
        if (/^121\.37\.30\.121$/.test(host)) return "DIRECT";
        if (/^224\.32\.32\.150$/.test(host)) return "+proxy";
        if (/^224\.32\.32\.142$/.test(host)) return "+proxy";
        if (/^224\.32\.32\.153$/.test(host)) return "+proxy";
